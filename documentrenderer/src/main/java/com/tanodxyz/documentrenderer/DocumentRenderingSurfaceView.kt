...
//
//    var pageFitPolicy: Document.PageFitPolicy = Document.PageFitPolicy.NONE
...
//        val pageEnd =
//        if(pageFitPolicy == Document.PageFitPolicy.FIT_WIDTH) {
//            val screenWidthInPixels = resources.displayMetrics.widthPixels
//            (screenWidthInPixels - pageMargins.right).toFloat()
//        } else if(pageFitPolicy == Document.PageFitPolicy.FIT_PAGE) {
//            //todo fit the page to the screen amigo
//            (page.originalSize.width - pageMargins.right)
//        } else {
//            (page.originalSize.width - pageMargins.right)
//        }
//        val pageBottom = (page.originalSize.height - pageMargins.bottom) + pageStartY
//        if (pageCorners > 0) {
...
//        }
//        currentOffsetY = pageStartY + (page.originalSize.height - pageMargins.bottom)
//    }
//
