...
public abstract class AbstractStatisticsEvent extends AbstractProductITextEvent {
    ...
    private static final Logger LOGGER = Logger.getLogger(AbstractStatisticsEvent.class.getName());
    ...
    public AbstractStatisticsAggregator createStatisticsAggregatorFromName(String statisticsName) {
        LOGGER.warning(MessageFormatUtil.format(CommonsLogMessageConstant.INVALID_STATISTICS_NAME, statisticsName));
        return null;
    }
