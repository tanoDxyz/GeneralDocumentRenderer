 ...
 */
package com.tanodxyz.itext722g.commons.actions.processors;
...
public class DefaultITextProductEventProcessor extends AbstractITextProductEventProcessor {
    ...
    private static final Logger LOGGER = Logger.getLogger(DefaultITextProductEventProcessor.class.getName());
    ...
    public void onEvent(AbstractProductProcessITextEvent event) {
        ...
        if (isNeededToLogMessage) {
            String message = new String(MESSAGE_FOR_LOGGING);
            LOGGER.info(message);
