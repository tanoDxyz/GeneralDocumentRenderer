 ...
 */
package com.tanodxyz.itext722g.commons.actions;
...
import com.tanodxyz.itext722g.commons.actions.contexts.UnknownContext;
import com.tanodxyz.itext722g.commons.actions.processors.DefaultITextProductEventProcessor;
...
import com.tanodxyz.itext722g.commons.exceptions.ProductEventHandlerRepeatException;
import com.tanodxyz.itext722g.commons.exceptions.UnknownProductException;
import com.tanodxyz.itext722g.commons.logs.CommonsLogMessageConstant;
    ...
    private void wrapConfirmedEvent(ConfirmEvent event, ITextProductEventProcessor productEventProcessor) {
        synchronized (events) {
            ...
            if (indexOfReportedEvent >= 0) {
                ...
                LOGGER.warning(MessageFormatUtil.format(CommonsLogMessageConstant.UNREPORTED_EVENT,
