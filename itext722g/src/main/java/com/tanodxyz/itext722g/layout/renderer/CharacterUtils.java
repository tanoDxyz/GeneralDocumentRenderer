...
public class CharacterUtils {
    ...
    public static boolean isUnicodeScriptUnknownCommonOrInherited(int unicode) {
        boolean commonInheritedOrUnknown = false;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            ...
            if (Character.UnicodeScript.COMMON.equals(glyphScript) || Character.UnicodeScript.UNKNOWN.equals(glyphScript)
                ...
                commonInheritedOrUnknown = true;
            }
        } else {
            UnicodeScript glyphScript = UnicodeScript.of(unicode);
            if (UnicodeScript.COMMON.equals(glyphScript) || UnicodeScript.UNKNOWN.equals(glyphScript)
                    || UnicodeScript.INHERITED.equals(glyphScript)) {
                commonInheritedOrUnknown = true;
            }
        }
        return commonInheritedOrUnknown;
    }
