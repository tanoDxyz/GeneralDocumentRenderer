...
import com.tanodxyz.itext722g.kernel.pdf.tagging.IStructureNode;
import com.tanodxyz.itext722g.kernel.pdf.tagging.PdfMcr;
...
public class TaggedPdfReaderTool {
    ...
    protected void inspectKid(IStructureNode kid) {
        try {
            ...
            throw new com.tanodxyz.itext722g.io.exceptions.IOException(com.tanodxyz.itext722g.io.exceptions.IOException.UnknownIOException, e);
        }
    }
