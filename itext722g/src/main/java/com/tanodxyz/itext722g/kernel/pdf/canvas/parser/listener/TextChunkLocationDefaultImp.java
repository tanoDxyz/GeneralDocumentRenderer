...
public class TextChunkLocationDefaultImp implements ITextChunkLocation {
    ...
    public static boolean containsMark(ITextChunkLocation baseLocation, ITextChunkLocation markLocation) {
